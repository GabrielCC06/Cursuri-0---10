...
dreptunghi_1 = Dreptunghi(6, 2, 'gri')
dreptunghi_2 = Dreptunghi(8, 4, 'bleu')

dreptunghi_1.descriere()
print(dreptunghi_1.aria())
print(dreptunghi_1.perimetrul())
dreptunghi_1.schimba_culoarea('turcuaz')
dreptunghi_1.descriere()
...
dreptunghi_2.schimba_culoarea('mov')
dreptunghi_2.descriere()
...
angajat_1 = Angajat('Turcu', 'Marius', 3500)
angajat_2 = Angajat('Velicu', 'Aura', 4000)
...
persoana_1 = Cont(1234, 'Ionita Florin', 6500)
persoana_2 = Cont(1213, 'Mihai Ion', 8500)
