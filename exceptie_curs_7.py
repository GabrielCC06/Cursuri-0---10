...
Folosim try - except pentru a gestiona posibilile exceptii(erori) aruncate in codul nostru, asfel incat programul sa nu se opreasca
...
# print(lista_numere[10]) # va sari  o eroare pt ca in lista nu exista indexul 10
...
# try:
#     print(lista_numere[10])
# except NotImplementedError as e:  # codul din try nu va arunca niciodata exteptia NotImplementerError
#     print(e)
...
#         raise IndexError('Numarul de studenti sa nu fie peste 5' )
